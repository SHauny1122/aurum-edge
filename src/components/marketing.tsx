...
export function Hero() {
  return (
    <section className="hero section-wrap" id="top">
      ...
      <div className="hero-meta"><span><i /> Available now</span><span>Designed for XAUUSD</span><span>TradingView required</span></div>
      <ChartPreview />
    </section>
  );
}
...
export function ProductSections() {
  return <>
    ...
    <section className="gold-section" id="gold"><div className="gold-orb orb-one" /><div className="gold-orb orb-two" /><div className="section-wrap gold-inner"><div className="section-kicker">03 / Built for Gold</div><div className="gold-copy"><h2>Focused on the<br /><span>metal that moves.</span></h2><p>Instead of trying to be another indicator for every asset on TradingView, Aurum Edge is developed around the behaviour of Gold.</p><div className="tag-row"><span>XAUUSD</span><span>Scalping</span><span>Intraday</span><span>TradingView</span></div></div><div className="quote-mark">“</div><p className="gold-quote">A focused tool for traders who want more context, not more clutter.</p></div></section>
    ...
    <section className="transparency-section"><div className="section-wrap transparency-inner"><div className="transparency-badge"><span className="status-pulse" /> Product status <strong>Live now</strong></div><div><div className="section-kicker">05 / Product transparency</div><h2>Built for the chart.<br /><span>Ready for your workflow.</span></h2><p>Aurum Edge is now available for XAUUSD chart analysis. Features and logic continue to be refined using real chart behaviour, with a focus on reliable market context and a clear TradingView experience.</p></div></div></section>
  </>;
}
